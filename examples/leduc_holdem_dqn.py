...
with tf.Session() as sess:
    ...
    for episode in range(episode_num):
        ...
        if episode % save_plot_every == 0 and episode > 0:
            logger.make_plot(save_path='./experiments/leduc_holdem_dqn_result/'+str(episode)+'.png')

    # Make the final plot
    logger.make_plot(save_path='./experiments/leduc_holdem_dqn_result/'+'final_'+str(episode)+'.png')
