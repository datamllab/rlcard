...
class EnvSpec(object):
    ...
    def make(self, allow_step_back=False, allow_raw_data=False):
        ...
        '''
        env = self._entry_point(allow_step_back, allow_raw_data)
        return env
...
class EnvRegistry(object):
    ...
    def make(self, env_id, allow_step_back=False, allow_raw_data=False):
        ...
        return self.env_specs[env_id].make(allow_step_back, allow_raw_data)
...
def make(env_id, allow_step_back=False, allow_raw_data=False):
    ''' Create and environment instance
    ...
    Args:
        ...
        allow_step_back (boolean): True if you wants to able to step_back
    '''
    return registry.make(env_id, allow_step_back, allow_raw_data)
